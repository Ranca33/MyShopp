...
namespace MyShop.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTests
    {
        ...
        public void CanCheckOutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "rancalucian@yahoo.com", ZipCode = "90210" });

            IPrincipal FakeUser =new GenericPrincipal(new GenericIdentity("rancalucian@yahoo.com", "Forms"), null);
